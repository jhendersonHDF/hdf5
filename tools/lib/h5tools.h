...
H5TOOLS_DLL herr_t       h5tools_apply_filters(hid_t dcpl_id, h5tools_filter_info_t *filter_info_list,
                                               size_t num_filters);
H5TOOLS_DLL void         h5tools_dump_filter_list(FILE *stream, h5tools_filter_info_t *filter_info_list,
                                                  size_t num_filters);
