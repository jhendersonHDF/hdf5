...
/*-------------------------------------------------------------------------
 * Function:    test_complex_type_conv
 *
 * Purpose:     Tests complex number datatype conversions.
 *
 * Return:      Success:    0
 *              Failure:    number of errors
 *-------------------------------------------------------------------------
 */
static int
test_complex_type_conv(void)
{
    H5T_t *native_float_complex   = NULL;
    ...
    /* TODO: write additional tests from _Float16 test */

    /* Ensure that complex number datatype conversion functions are library hard conversions */
...
#ifdef H5_HAVE_COMPLEX_NUMBERS
    nerrors += test_complex_type_conv();
#endif
