 ...
 *
 * Purpose:     Converts `_Float16' to `float _Complex'
 *
 * Return:      Non-negative on success/Negative on failure
 *
 *-------------------------------------------------------------------------
...
H5T__conv__Float16_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                            ...
                            size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(FLOAT16, FLOAT_COMPLEX, H5__Float16, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv__Float16_dcomplex
 *
 * Purpose:     Converts `_Float16' to `double _Complex'
 *
 * Return:      Non-negative on success/Negative on failure
 *
 *-------------------------------------------------------------------------
...
H5T__conv__Float16_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                            ...
                            size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(FLOAT16, DOUBLE_COMPLEX, H5__Float16, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv__Float16_lcomplex
 *
 * Purpose:     Converts `_Float16' to `long double _Complex'
 *
 * Return:      Non-negative on success/Negative on failure
 *
 *-------------------------------------------------------------------------
...
H5T__conv__Float16_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                            ...
                            size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(FLOAT16, LDOUBLE_COMPLEX, H5__Float16, long double _Complex, -, -);
}
#endif
#endif
 ...
 *
 * Purpose:     Convert native `float' to native `float _Complex' using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_float_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fz(FLOAT, FLOAT_COMPLEX, float, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_float_dcomplex
 *
 * Purpose:     Convert native `float' to native `double _Complex' using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_float_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(FLOAT, DOUBLE_COMPLEX, float, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_float_lcomplex
 *
 * Purpose:     Convert native `float' to native `long double _Complex'
...
H5T__conv_float_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(FLOAT, LDOUBLE_COMPLEX, float, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native `double' to native `float _Complex' using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_double_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_Fz(DOUBLE, FLOAT_COMPLEX, double, float _Complex, -FLT_MAX, FLT_MAX);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_double_dcomplex
 *
 * Purpose:     Convert native `double' to native `double _Complex' using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_double_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fz(DOUBLE, DOUBLE_COMPLEX, double, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_double_lcomplex
 *
 * Purpose:     Convert native `double' to native `long double _Complex'
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_double_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fZ(DOUBLE, LDOUBLE_COMPLEX, double, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native `long double' to native `float _Complex'
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ldouble_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                           ...
                           size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_Fz(LDOUBLE, FLOAT_COMPLEX, long double, float _Complex, -FLT_MAX, FLT_MAX);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ldouble_dcomplex
 *
 * Purpose:     Convert native `long double' to native `double _Complex'
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ldouble_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                           ...
                           size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_Fz(LDOUBLE, DOUBLE_COMPLEX, long double, double _Complex, -DBL_MAX, DBL_MAX);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ldouble_lcomplex
 *
 * Purpose:     Convert native `long double' to native `long double _Complex'
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ldouble_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                           ...
                           size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_fz(LDOUBLE, LDOUBLE_COMPLEX, long double, long double _Complex, -, -);
}
#endif
