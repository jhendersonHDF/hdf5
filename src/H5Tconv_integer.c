 ...
 *
 * Purpose:     Convert native signed char to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_schar_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SCHAR, FLOAT_COMPLEX, signed char, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_schar_dcomplex
 *
 * Purpose:     Convert native signed char to native double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_schar_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SCHAR, DOUBLE_COMPLEX, signed char, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_schar_lcomplex
 *
 * Purpose:     Convert native signed char to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
 *-------------------------------------------------------------------------
...
H5T__conv_schar_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SCHAR, LDOUBLE_COMPLEX, signed char, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native unsigned char to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uchar_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UCHAR, FLOAT_COMPLEX, unsigned char, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_uchar_dcomplex
 *
 * Purpose:     Convert native unsigned char to native double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uchar_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UCHAR, DOUBLE_COMPLEX, unsigned char, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_uchar_lcomplex
 *
 * Purpose:     Convert native unsigned char to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uchar_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UCHAR, LDOUBLE_COMPLEX, unsigned char, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native short to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_short_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SHORT, FLOAT_COMPLEX, short, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_short_dcomplex
 *
 * Purpose:     Convert native short to native double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_short_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SHORT, DOUBLE_COMPLEX, short, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_short_lcomplex
 *
 * Purpose:     Convert native short to native long double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_short_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(SHORT, LDOUBLE_COMPLEX, short, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native unsigned short to native float _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ushort_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(USHORT, FLOAT_COMPLEX, unsigned short, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ushort_dcomplex
 *
 * Purpose:     Convert native unsigned short to native double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ushort_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(USHORT, DOUBLE_COMPLEX, unsigned short, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ushort_lcomplex
 *
 * Purpose:     Convert native unsigned short to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ushort_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(USHORT, LDOUBLE_COMPLEX, unsigned short, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native integer to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_int_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                       ...
                       void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(INT, FLOAT_COMPLEX, int, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_int_dcomplex
 *
 * Purpose:     Convert native integer to native double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_int_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                       ...
                       void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(INT, DOUBLE_COMPLEX, int, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_int_lcomplex
 *
 * Purpose:     Convert native integer to native long double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_int_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                       ...
                       void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(INT, LDOUBLE_COMPLEX, int, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native unsigned integer to native float _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uint_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UINT, FLOAT_COMPLEX, unsigned int, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_uint_dcomplex
 *
 * Purpose:     Convert native unsigned integer to native double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uint_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UINT, DOUBLE_COMPLEX, unsigned int, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_uint_lcomplex
 *
 * Purpose:     Convert native unsigned integer to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_uint_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(UINT, LDOUBLE_COMPLEX, unsigned int, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native long to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_long_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LONG, FLOAT_COMPLEX, long, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_long_dcomplex
 *
 * Purpose:     Convert native long to native double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_long_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LONG, DOUBLE_COMPLEX, long, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_long_lcomplex
 *
 * Purpose:     Convert native long to native long double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_long_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                        ...
                        void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LONG, LDOUBLE_COMPLEX, long, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native unsigned long to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ulong_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULONG, FLOAT_COMPLEX, unsigned long, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ulong_dcomplex
 *
 * Purpose:     Convert native unsigned long to native double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ulong_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULONG, DOUBLE_COMPLEX, unsigned long, double _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ulong_lcomplex
 *
 * Purpose:     Convert native unsigned long to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ulong_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULONG, LDOUBLE_COMPLEX, unsigned long, long double _Complex, -, -);
}
#endif
 ...
 *
 * Purpose:     Convert native long long to native float _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_llong_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LLONG, FLOAT_COMPLEX, long long, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_llong_dcomplex
 *
 * Purpose:     Convert native long long to native double _Complex using
 *              hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_llong_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LLONG, DOUBLE_COMPLEX, long long, double _Complex, -, -);
}
 ...
 *
 * Purpose:     Convert native long long to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_llong_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata, const H5T_conv_ctx_t *conv_ctx,
                         ...
                         void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(LLONG, LDOUBLE_COMPLEX, long long, long double _Complex, -, -);
}
#endif /* H5T_CONV_INTERNAL_LLONG_LDOUBLE */
 ...
 *
 * Purpose:     Convert native unsigned long long to native float _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ullong_fcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULLONG, FLOAT_COMPLEX, unsigned long long, float _Complex, -, -);
}

/*-------------------------------------------------------------------------
 * Function:    H5T__conv_ullong_dcomplex
 *
 * Purpose:     Convert native unsigned long long to native double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ullong_dcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULLONG, DOUBLE_COMPLEX, unsigned long long, double _Complex, -, -);
}
 ...
 *
 * Purpose:     Convert native unsigned long long to native long double _Complex
 *              using hardware. This is a fast special case.
 *
 * Return:      Non-negative on success/Negative on failure
 *
...
H5T__conv_ullong_lcomplex(const H5T_t *st, const H5T_t *dt, H5T_cdata_t *cdata,
                          ...
                          size_t H5_ATTR_UNUSED bkg_stride, void *buf, void H5_ATTR_UNUSED *bkg)
{
    H5T_CONV_xZ(ULLONG, LDOUBLE_COMPLEX, unsigned long long, long double _Complex, -, -);
}
#endif /* H5T_CONV_INTERNAL_ULLONG_LDOUBLE */
#endif /* H5_HAVE_COMPLEX_NUMBERS */
