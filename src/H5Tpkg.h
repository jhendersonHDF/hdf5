...
H5_DLLVAR float _Complex H5T_NATIVE_FLOAT_COMPLEX_POS_INF_g;
H5_DLLVAR float _Complex H5T_NATIVE_FLOAT_COMPLEX_NEG_INF_g;
H5_DLLVAR double _Complex H5T_NATIVE_DOUBLE_COMPLEX_POS_INF_g;
H5_DLLVAR double _Complex H5T_NATIVE_DOUBLE_COMPLEX_NEG_INF_g;
H5_DLLVAR long double _Complex H5T_NATIVE_LDOUBLE_COMPLEX_POS_INF_g;
H5_DLLVAR long double _Complex H5T_NATIVE_LDOUBLE_COMPLEX_NEG_INF_g;
#endif
